...
const VARIANTS = {
  primary: 'bg-primary-container hover:bg-primary-container/90 active:scale-[0.98] text-white font-medium shadow-sm disabled:opacity-75 disabled:cursor-not-allowed',
